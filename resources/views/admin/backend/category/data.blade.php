    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="animate-fade-in">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-sage-800">Manajemen Kategori</h1>
                    <p class="text-sage-600 mt-1">Kelola semua data Kategori di toko Anda.</p>
                </div>
                <div class="flex items-center gap-4 w-full sm:w-auto">
                    <!-- Search Bar -->
                    <form action="{{ route('categoryView') }}" method="GET">
                    ...
                    <table class="min-w-max w-full text-sm sm:text-base divide-y divide-sage-100">
                        <thead class="bg-[#7eb17e] text-black uppercase text-xs tracking-wider">
                            <tr>
                                ...
                                <th class="px-2 py-2 sm:px-4 sm:py-3 text-center font-bold">Nama Kategori</th>
                                <th class="px-2 py-2 sm:px-4 sm:py-3 text-center font-bold hidden md:table-cell">Deskripsi
                                </th>
                                <th class="px-2 py-2 sm:px-4 sm:py-3 text-center font-bold hidden md:table-cell">Slug</th>
