                                ...
                                <tr class="hover:bg-sage-50/50 transition-colors duration-200 animate-fade-in-up"
                                    ...
                                    <td class="px-2 py-4 whitespace-nowrap">
                                        <div class="flex justify-center">
                                            ...
                                            @else
                                                <div
                                                    class="w-16 h-16 bg-sage-100 rounded-lg flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 text-center font-semibold align-top">
                                        <p class="text-sm text-gray-600">{{ $item->nama_produk }}</p>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center font-semibold align-top">
                                        <span
                                            class="px-3 py-1 text-xs font-semibold rounded-full {{ $item->stok > 10 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                            {{ $item->stok }} Pcs
                                        </span>
                                    </td>
