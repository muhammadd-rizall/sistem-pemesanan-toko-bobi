    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="animate-fade-in">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-sage-800">Manajemen Diskon</h1>
                    <p class="text-sage-600 mt-1">Kelola semua data Diskon di toko Anda.</p>
                </div>
                <div class="flex items-center gap-4 w-full sm:w-auto">
                    <!-- Search Bar -->
                    <form action="{{ route('diskonView') }}" method="GET">
                    ...
                    <a href="{{ route('createDiskon') }}"
                        ...
                        <span class="whitespace-nowrap">Tambah Diskon</span>
                    </a>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-sage-50 transition duration-200">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form action="{{ route('deleteDiskon', $data->id) }}" method="POST"
                                                class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
