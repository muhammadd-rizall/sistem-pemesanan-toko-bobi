    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        @if (session('success'))
            <div id="success-alert"
                class="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg shadow flex items-center justify-between"
                role="alert">
        ...
        <div class="animate-fade-in">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-x-auto">
                <table class="table-auto w-full divide-y divide-sage-100">
                    ...
                    <tbody class="divide-y divide-sage-100">
                        @forelse ($orders as $index => $order)
                            <tr class="hover:bg-sage-50 transition-colors duration-200 animate-fade-in-up"
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    @endphp
                                    <span
                                        class="px-3 py-1 rounded-full text-xs font-semibold {{ $statusClasses[$order->status] ?? 'bg-gray-100 text-gray-800' }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center py-10 text-gray-500">Belum ada data produk.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
