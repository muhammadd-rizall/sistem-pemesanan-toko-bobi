        ...
        <div class="max-w-6xl mx-auto">
                            ...
                            <div class="bg-white rounded-2xl shadow-lg p-6">
                                <div class="flex items-center gap-3 mb-6">
                                    <svg class="w-6 h-6 text-[#7eb17e]" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.210l-2.257 1.130a11.042 11.042 0 005.516 5.516l1.130-2.257a1 1 0 011.210-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z">
                                        </path>
                                    </svg>
                                ...
                                <label class="block text-sm font-semibold text-gray-700 mb-2 mt-4">Catatan
                                    Tambahan</label>
                                ...
                                <div class="space-y-4 mb-6">
                                    ...
                                    <div class="border-t-2 border-gray-200 pt-4">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span id="total-harga-akhir" class="text-2xl font-bold text-[#7eb17e]">
                                                Rp {{ number_format($product->harga_jual - $diskonNilai, 0, ',', '.') }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            @else
                <div class="bg-white rounded-2xl shadow-lg p-8 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Anda harus login terlebih dahulu untuk dapat memesan produk.</p>
                    <a href="{{ route('customer.login') }}"
                        class="bg-[#7eb17e] hover:bg-[#6da16d] text-white font-bold py-3 px-6 rounded-lg transition">
                        Login Sekarang
                    </a>
                </div>
            @endauth
