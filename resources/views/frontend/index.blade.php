        ...
        <section id="keunggulan" class="py-16 sm:py-4">
            <div class="container mx-auto px-0 sm:px-0 lg:px-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 sm:gap-10 px-16">
                    ...
                    <div class="bg-white p-8 rounded-2xl border border-sage-200 shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 animate-fade-in-up" style="animation-delay: 0.1s;">
                        <div class="flex flex-col items-center text-center">
                            <!-- Ikon -->
                            <div class="mx-auto w-20 h-20 mb-6 flex items-center justify-center bg-gradient-to-br from-sage-100 to-sage-200 rounded-full text-sage-600">
                    ...
                    <div class="bg-white p-8 rounded-2xl border border-sage-200 shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 animate-fade-in-up" style="animation-delay: 0.2s;">
                        <div class="flex flex-col items-center text-center">
                            <!-- Ikon -->
                            <div class="mx-auto w-20 h-20 mb-6 flex items-center justify-center bg-gradient-to-br from-sage-100 to-sage-200 rounded-full text-sage-600">
                    ...
                    <div class="bg-white p-8 rounded-2xl border border-sage-200 shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 animate-fade-in-up" style="animation-delay: 0.3s;">
                        <div class="flex flex-col items-center text-center">
                            <!-- Ikon -->
                            <div class="mx-auto w-20 h-20 mb-6 flex items-center justify-center bg-gradient-to-br from-sage-100 to-sage-200 rounded-full text-sage-600">
                ...
                <div class="bg-white rounded-2xl border-2 border-sage-200 shadow-xl overflow-hidden animate-fade-in-up">
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-1 p-8 bg-sage-50 flex flex-col justify-center">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="flex items-start gap-4">
                                    <svg class="w-6 h-6 text-sage-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                    <div>
                                        <h4 class="font-semibold text-sage-800">Alamat</h4>
                                        <p class="text-sage-700">Jl. Kp. Kalawi Jl. Kp. Lalang No.11, Lubuk Lintah, Kec. Kuranji, Kota Padang, Sumatera Barat 25175</p>
                                    </div>
                                </div>
                                <!-- Jam Buka -->
                                <div class="flex items-start gap-4">
                                    <svg class="w-6 h-6 text-sage-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <div>
                        ...
                        <div class="lg:col-span-2 h-80 lg:h-full">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.2998797168048!2d100.39208897411788!3d-0.9236666990674066!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b8ff554d4235%3A0xf6a316c972be521b!2sToko%20Keramik%20Bobi!5e0!3m2!1sid!2sid!4v1760443143438!5m2!1sid!2sid"
