                    ...
                    <div class="relative z-10">
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            ...
                            <div class="flex items-center space-x-3">
                                <!-- Tombol Review Global -->
                                <a href="{{ route('customer.review.index') }}"
                                    class="group flex items-center space-x-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white rounded-full px-6 py-3 transition-all duration-300 hover:scale-105">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                    <span class="font-semibold">Review Saya</span>
                                ...
                                <div class="flex items-center justify-between lg:justify-end gap-4">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        @elseif ($order->status == 'selesai')
                                            <a href="{{ route('customer.orders.preview.show', ['order' => $order->id]) }}"
                                                class="px-5 py-2.5 bg-sage-600 text-white rounded-xl">
                                                Detail
                                            </a>

                                            @if ($order->review)
                                                <a href="{{ route('customer.review.edit', $order->review->id) }}"
                                                    class="px-5 py-2.5 bg-green-100 text-green-700 rounded-xl hover:bg-green-200 transition-all flex items-center space-x-2">
                                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                    </svg>
                                            ...
                                            @else
                                                <a href="{{ route('customer.review.create', $order->id) }}"
                                                    class="px-5 py-2.5 bg-yellow-500 text-white rounded-xl hover:bg-yellow-600 transition-all flex items-center space-x-2">
                                                    <span>⭐</span>
